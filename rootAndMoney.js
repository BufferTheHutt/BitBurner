...
export async function main(ns) {
    ...
    if (ns.hasRootAccess(target)) {
        ns.exec("gimme-money.js", server, threats, target);
        ns.tprint(`gimme-money.js wurde mit ${threats} Threads auf ${server} gestartet, um das Ziel ${target} anzugreifen.`);
    } else {
